...
Fase 3 completada (2026-07-14). Env vars de Fase 1 (`ADMIN_USERNAME`/`ADMIN_PASSWORD_HASH`/`JWT_SECRET`) y Fase 2 (`GOOGLE_APPLICATION_CREDENTIALS_JSON`) ya están configuradas en Render, y el bug 500 de `POST /generar` en producción ya no ocurre. Próximo paso: Fase 4 (Ventas presenciales).
